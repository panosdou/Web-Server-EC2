...
<body>
<h2>Enter a number to test if it is Prime</h2> <form action="/primality-test" method="post">
...
`;
server.get('/', function(req, res) { res.writeHead(200, {'Content-Type':'text/html'});
res.end(htmlContent); });

server.post('/primality-test', function(req, res) { res.writeHead(200, {'Content-Type':'text/html'});
